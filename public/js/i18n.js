    ...
    loadTranslations() {
        this.translations = {
            en: {
                ...
                // Purchase
                'purchase.title': "Upgrade to Premium",
                'purchase.features': "Premium Features",
                'purchase.voice_recording': "Voice Recording",
                'purchase.audio_upload': "Audio File Upload",
                'purchase.voice_effects': "10+ Voice Effects",
                'purchase.unlimited_use': "Unlimited Usage",
                'purchase.priority_support': "Priority Support",
                'purchase.monthly_plan': "Monthly Plan",
                'purchase.yearly_plan': "Yearly Plan",
                'purchase.per_month': "/month",
                ...
                'pricing.starter.f1': "10 voice conversions per month (No limit on the number of times)",
                ...
                'pricing.pro.f1': "100 voice conversions per month (No limit on the number of times)",
            ...
            zh: {
                ...
                'auth.login_to_use': "请登录以使用语音录制和转换功能。",
                
                // Purchase
                'purchase.title': "升级到高级版",
                'purchase.features': "高级功能",
                'purchase.voice_recording': "语音录制",
                'purchase.audio_upload': "音频文件上传",
                'purchase.voice_effects': "10+ 语音效果",
                'purchase.unlimited_use': "无限使用",
                'purchase.priority_support': "优先支持",
                'purchase.monthly_plan': "月付计划",
                'purchase.yearly_plan': "年付计划",
                'purchase.per_month': "/月",
                'purchase.per_year': "/年",
            ...
            es: {
                ...
                'auth.login_to_use': "Por favor inicia sesión para usar las funciones de grabación y transformación de voz.",
                
                // Purchase
                'purchase.title': "Actualizar a Premium",
                'purchase.features': "Características Premium",
                'purchase.voice_recording': "Grabación de Voz",
                'purchase.audio_upload': "Subida de Archivos de Audio",
                'purchase.voice_effects': "10+ Efectos de Voz",
                'purchase.unlimited_use': "Uso Ilimitado",
                'purchase.priority_support': "Soporte Prioritario",
                'purchase.monthly_plan': "Plan Mensual",
                'purchase.yearly_plan': "Plan Anual",
                'purchase.per_month': "/mes",
